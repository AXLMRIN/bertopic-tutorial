...
![](./assets/clustering_metrics-1.png){width=100%, fig-align="center"}

![](./assets/clustering_metrics-2.png){width=100%, fig-align="center"}

![](./assets/clustering_metrics-3.png){width=100%, fig-align="center"}
...
<br/>
These scores were often used to optimise the number of topics for LDA techniques but not to compare two topic models 

!["Figure 1: Overview over the unifying coherence framework — its four parts and their intermediate results." (Röder et al., 2015)](./assets/coherence_metrics.png){#fig-coherene-framework width=100%, fig-align="center"}
...
![](./assets/coherence_metrics-1.png){width=100%, fig-align="center"}

![](./assets/coherence_metrics-2.png){#fig-coherence-metrics-2 width=100%, fig-align="center"}

![](./assets/coherence_metrics-3.png){width=100%, fig-align="center"}
